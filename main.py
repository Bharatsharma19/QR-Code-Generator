...
# Creating the window
wn = Tk()
wn.title('QR Code Generator Developed by Bharat Sharma')
wn.geometry('700x700')
wn.config(bg='SteelBlue3')
# Label for the window
headingFrame = Frame(wn, bg="azure", bd=5)
headingFrame.place(relx=0.15, rely=0.05, relwidth=0.7, relheight=0.1)
headingLabel = Label(headingFrame, text="Generate QR Code with Bharat Sharma",
...
def generateCode():
    ...
    messagebox.showinfo("DataFlair QR Code Generator",
...
label4 = Label(Frame4, text="Enter the size from 1 to 40 with 1 being 21x21: ",
               bg="SteelBlue3", fg='azure', font=('Courier', 13, 'bold'))
